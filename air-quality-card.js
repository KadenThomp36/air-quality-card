...
const METRIC_DEFS = {
  ...
  nox:        { defaultThresholds: [20, 50, 150, 250],       colors: SCALE_AIRQUALITY, labelKeys: ['excellent', 'good', 'moderate', 'elevated', 'poor'] },
